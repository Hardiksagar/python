...
if __name__=='__main__':
    ...
    instances=["instance1", "instance2", "instance3", "instance4", "instance5"]
    for i in range(len(instances)):
        if i==0: instances[i] = Boeing_747(11,7,10,23)
        if i==1: instances[i] = Boeing_747(11,14,45,41)
        if i==2: instances[i] = Boeing_747(17,15,33,35)
        if i==3: instances[i] = Boeing_747(5,11,21,5)
        if i==4: instances[i] = Boeing_747(7,9,88,56)
